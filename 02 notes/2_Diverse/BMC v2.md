...
## 8. Key partnerships
- **Trusler fra substitutter:** Kompleksiteten ved den service vi leverer er lav, og kan nemt løses med andre eksisterende services på markedet. (porters)
- **Komplementerende**: cloud sync services med en freemium model (porters)
- Bibliotek 
	- Location (borde, stole)
	- Brætspil (vores value propersition er ikke brætspilscafeer, men at gøre afholdelsen af dem nemmere).
